...
import com.gn.Main;
import com.stock.global.Section;
import com.stock.global.User;
import com.stock.global.UserDetail;
import com.stock.global.plugin.SectionManager;
import com.stock.global.plugin.UserManager;
    ...
    private void loginAction(){
        try {
            ...
            ViewManager.getInstance().put(
                    "login",
                    FXMLLoader.load(getClass().getResource("/app/views/dashboard.fxml"))
            );
